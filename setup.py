...
CK_API_FWD_SEQ_LEN_COMMIT = "518d24e6628eb0c91a56748d26ac8910813c8dcb"
CK_API_BWD_UNIFIED_SEQ_LEN_COMMIT = "7c6430eca04e62454217630ae2a0bbd70ff50a00"
...
def get_ck_git_commit(ck_dir: str) -> str:
...
def write_ck_build_config(ck_dir: str) -> None:
    ...
    flags = {
        "FLASHATTN_CK_HAS_VARIANT_DROP_SEED": ck_commit_is_at_least(
            ck_dir, ck_commit, CK_API_VARIANT_DROP_SEED_COMMIT
        ),
        "FLASHATTN_CK_HAS_FWD_SEQ_LEN_API": ck_commit_is_at_least(
            ck_dir, ck_commit, CK_API_FWD_SEQ_LEN_COMMIT
        ),
        "FLASHATTN_CK_HAS_BWD_UNIFIED_SEQ_LEN_API": ck_commit_is_at_least(
            ck_dir, ck_commit, CK_API_BWD_UNIFIED_SEQ_LEN_COMMIT
        ),
    }
    content = [
        ...
        "#pragma once",
        "",
        f'#define FLASHATTN_CK_GIT_COMMIT "{ck_commit}"',
    ]
    for name, enabled in flags.items():
        content.append(f"#define {name} {1 if enabled else 0}")
    content.append("")
